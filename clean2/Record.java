...
public class Record {
   ...
   boolean prepit = true;
   ContO[] ocar = new ContO[Madness.playerSlots()];
   int cntf = 50;
   ContO[][] car = new ContO[6][Madness.playerSlots()];
   int[][] squash = new int[6][Madness.playerSlots()];
   int[] fix = new int[Madness.playerSlots()];
   int[] dest = new int[Madness.playerSlots()];
   int[][] x = new int[300][Madness.playerSlots()];
   int[][] y = new int[300][Madness.playerSlots()];
   int[][] z = new int[300][Madness.playerSlots()];
   int[][] xy = new int[300][Madness.playerSlots()];
   int[][] zy = new int[300][Madness.playerSlots()];
   int[][] xz = new int[300][Madness.playerSlots()];
   int[][] wxz = new int[300][Madness.playerSlots()];
   int[][] wzy = new int[300][Madness.playerSlots()];
   int[][] ns = new int[Madness.playerSlots()][20];
   int[][][] sspark = new int[Madness.playerSlots()][20][30];
   int[][][] sx = new int[Madness.playerSlots()][20][30];
   int[][][] sy = new int[Madness.playerSlots()][20][30];
   int[][][] sz = new int[Madness.playerSlots()][20][30];
   float[][][] smag = new float[Madness.playerSlots()][20][30];
   int[][][] scx = new int[Madness.playerSlots()][20][30];
   int[][][] scz = new int[Madness.playerSlots()][20][30];
   int[] nr = new int[Madness.playerSlots()];
   int[][] rspark = new int[Madness.playerSlots()][200];
   int[][] sprk = new int[Madness.playerSlots()][200];
   int[][] srx = new int[Madness.playerSlots()][200];
   int[][] sry = new int[Madness.playerSlots()][200];
   int[][] srz = new int[Madness.playerSlots()][200];
   float[][] rcx = new float[Madness.playerSlots()][200];
   float[][] rcy = new float[Madness.playerSlots()][200];
   float[][] rcz = new float[Madness.playerSlots()][200];
   int[][] nry = new int[Madness.playerSlots()][4];
   int[][][] ry = new int[Madness.playerSlots()][4][7];
   int[][][] magy = new int[Madness.playerSlots()][4][7];
   boolean[][] mtouch = new boolean[Madness.playerSlots()][7];
   int[][] nrx = new int[Madness.playerSlots()][4];
   int[][][] rx = new int[Madness.playerSlots()][4][7];
   int[][][] magx = new int[Madness.playerSlots()][4][7];
   int[][] nrz = new int[Madness.playerSlots()][4];
   int[][][] rz = new int[Madness.playerSlots()][4][7];
   int[][][] magz = new int[Madness.playerSlots()][4][7];
   ...
   int powered = 0;
   int closefinish = 0;
   ContO[] starcar = new ContO[Madness.playerSlots()];
   int[] hsquash = new int[Madness.playerSlots()];
   int[] hfix = this.newFilledPlayerInts(-1);
   int[] hdest = this.newFilledPlayerInts(-1);
   int[][] hx = new int[300][Madness.playerSlots()];
   int[][] hy = new int[300][Madness.playerSlots()];
   int[][] hz = new int[300][Madness.playerSlots()];
   int[][] hxy = new int[300][Madness.playerSlots()];
   int[][] hzy = new int[300][Madness.playerSlots()];
   int[][] hxz = new int[300][Madness.playerSlots()];
   int[][] hwxz = new int[300][Madness.playerSlots()];
   int[][] hwzy = new int[300][Madness.playerSlots()];
   int[][][] hsspark = new int[Madness.playerSlots()][20][30];
   int[][][] hsx = new int[Madness.playerSlots()][20][30];
   int[][][] hsy = new int[Madness.playerSlots()][20][30];
   int[][][] hsz = new int[Madness.playerSlots()][20][30];
   float[][][] hsmag = new float[Madness.playerSlots()][20][30];
   int[][][] hscx = new int[Madness.playerSlots()][20][30];
   int[][][] hscz = new int[Madness.playerSlots()][20][30];
   int[][] hrspark = new int[Madness.playerSlots()][200];
   int[][] hsprk = new int[Madness.playerSlots()][200];
   int[][] hsrx = new int[Madness.playerSlots()][200];
   int[][] hsry = new int[Madness.playerSlots()][200];
   int[][] hsrz = new int[Madness.playerSlots()][200];
   float[][] hrcx = new float[Madness.playerSlots()][200];
   float[][] hrcy = new float[Madness.playerSlots()][200];
   float[][] hrcz = new float[Madness.playerSlots()][200];
   int[][][] hry = new int[Madness.playerSlots()][4][7];
   int[][][] hmagy = new int[Madness.playerSlots()][4][7];
   int[][][] hrx = new int[Madness.playerSlots()][4][7];
   int[][][] hmagx = new int[Madness.playerSlots()][4][7];
   int[][][] hrz = new int[Madness.playerSlots()][4][7];
   int[][][] hmagz = new int[Madness.playerSlots()][4][7];
   boolean[][] hmtouch = new boolean[Madness.playerSlots()][7];
   int[] hcheckpoint = new int[300];
   boolean[] hlastcheck = new boolean[300];
   int[] cntdest = new int[Madness.playerSlots()];
   int lastfr = 0;
   ...
   private int[] newFilledPlayerInts(int var1) {
      int[] var2 = new int[Madness.playerSlots()];
   ...
   public void reset(ContO[] var1) {
      ...
      for (int var5 = 0; var5 < 6; var5++) {
         for (int var3 = 0; var3 < Madness.playerSlots(); var3++) {
            this.car[var5][var3] = new ContO(var1[var3], 0, 0, 0, 0);
            this.squash[var5][var3] = 0;
         }
      }

      for (int var6 = 0; var6 < Madness.playerSlots(); var6++) {
         this.nr[var6] = 0;
   ...
   public void cotchinow(int var1) {
      if (this.caught >= 300) {
         ...
         for (int var7 = 0; var7 < Madness.playerSlots(); var7++) {
         ...
         for (int var8 = 0; var8 < Madness.playerSlots(); var8++) {
