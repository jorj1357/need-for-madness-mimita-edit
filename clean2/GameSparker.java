...
public class GameSparker extends Applet implements Runnable {
   ...
   public void run() {
      ...
      var6.stoploading();
      if (Madness.autotestMode == 1 || Madness.autotestMode == 2) {
         var6.firstime = false;
         var6.multion = 0;
         var6.clangame = 0;
         var6.gmode = Madness.autotestMode;
         var6.opselect = 0;
         var6.fase = -9;
         System.out.println("[AUTOTEST] starting NFM" + Madness.autotestMode + " at car-select transition");
      }
      ...
      int var29 = 0;
      boolean var30 = false;
      int lastFase = Integer.MIN_VALUE;
      ...
      while (true) {
         ...
         if (Madness.autotestMode != 0) {
            ...
            if ((var6.fase == 7 || var6.fase == 1 || var6.fase == 6) && autoCount == 20) {
               System.out.println("[AUTOTEST] pressing continue in fase=" + var6.fase);
               this.u[0].enter = true;
            }

            if (var6.fase == 0 && autoCount == 20) {
               System.out.println("[AUTOTEST] pressing accelerator in gameplay");
               this.u[0].up = true;
            }

            if (var6.fase == 0 && autoCount == 60) {
               this.u[0].up = false;
            }
         }

         if (var6.fase != lastFase || var3.stage != lastStage) {
            System.out.println(
               "[STATE] fase=" + lastFase + " -> " + var6.fase
                  + ", stage=" + lastStage + " -> " + var3.stage
                  + ", gmode=" + var6.gmode
                  + ", multion=" + var6.multion
                  + ", nplayers=" + var6.nplayers
                  + ", loadedt=" + var6.loadedt
            );
            lastFase = var6.fase;
            lastStage = var3.stage;
         }
         if (var6.fase == 111) {
            if (this.mouses == 1) {
               var27 = 800;
   ...
   public void loadstage(ContO[] var1, ContO[] var2, Medium var3, Trackers var4, CheckPoints var5, xtGraphics var6, Mad[] var7, Record var8) {
      System.out.println(
         "[LOADSTAGE] start fase=" + var6.fase
            + ", stage=" + var5.stage
            + ", name=" + var5.name
            + ", gmode=" + var6.gmode
            + ", multion=" + var6.multion
      ...
      try {
         ...
         var5.stage = -3;
         System.out.println("[LOADSTAGE] failed; current line: " + var14);
      ...
      System.out.println(
         "[LOADSTAGE] end fase=" + var6.fase
            + ", stage=" + var5.stage
            + ", checkpoints=" + var5.nsp
            + ", objects=" + this.nob
            + ", trackers=" + var4.nt
            + ", trackname=" + var5.trackname
            + ", trackvol=" + var5.trackvol
      );
      System.gc();
   }
   ...
   public void loadbase(ContO[] var1, Medium var2, Trackers var3, xtGraphics var4, boolean var5) {
      ...
      try {
         ...
         while (var19 != null) {
            ...
            while (var22 > 0) {
               int var15 = var9.read(var11, var14, var22);
               var14 += var15;
               var22 -= var15;
            }

            var1[var12] = new ContO(var11, var2, var3);
            var4.dnload++;
            var19 = var9.getNextEntry();
         }
   ...
   public void setcarcookie(int var1, String var2, float[] var3, int var4, int[] var5, boolean var6) {
      try {
         File var7 = new File("" + Madness.fpath + "data/user.data");
   ...
   public void setloggedcookie() {
      try {
         File var1 = new File("" + Madness.fpath + "data/user.data");
   ...
   public void readcookies(xtGraphics var1, CarDefine var2, ContO[] var3) {
      ...
      try {
         File var4 = new File("" + Madness.fpath + "data/user.data");
   ...
   public void setupini() {
      ...
      try {
         ...
         if (var1.exists()) {
            ...
            while ((var5 = var4.readLine()) != null && var3 < 40) {
