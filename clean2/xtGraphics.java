...
public class xtGraphics extends Panel implements Runnable {
   ...
   public void loaddata() {
      ...
      this.runner.start();
      this.loadimages();
            System.out.println("LOADDATA images sss");

      this.intertrack = new RadicalMod("music/interface.zip");
            System.out.println("LOADDATA interfacece");

      this.dnload += 44;
      this.loadsounds();
            System.out.println("LOADDATA sounds lo sounds");

   }

   public void loadsounds() {
            System.out.println("LOADSOUNDS START");
      ...
      try {
         ...
         ZipInputStream var3 = new ZipInputStream(var2);
                     System.out.println("LOADSOUNDS try sounds");
         ...
         for (ZipEntry var4 = var3.getNextEntry(); var4 != null; var4 = var3.getNextEntry()) {
            ...
            if (var6.equals("firewasted.wav")) {
               this.firewasted = new soundClip(var7);
                        ...
                        System.out.println("LOADSOUNDS vfirewasted etc");
   ...
   public void rad(int var1) {
      ...
      if (this.radpx == 212) {
         this.rd.setFont(new Font("Arial", 1, 11));
         this.ftm = this.rd.getFontMetrics();
         this.drawcs(185 + (int)(5.0F * this.m.random()), "Radicalplay.com ORIGINAL, www.mimita.fun MODDED", 112, 120, 143, 3);
      }

      this.rd.setFont(new Font("Arial", 1, 11));
      this.ftm = this.rd.getFontMetrics();
      if (this.aflk) {
         this.drawcs(215, "And we are never going to find the new unless we get a little crarararararrzy...", 112, 120, 143, 3);
         this.aflk = false;
      } else {
         this.drawcs(217, "Tung tung tung tung tung tung tung tung tung tung sahur...", 150, 150, 150, 3);
         this.aflk = true;
      }
   ...
   public void loadmusic(int var1, String var2, int var3) {
      System.out.println("[LOADMUSIC] start stage=" + var1 + ", trackname=" + var2 + ", trackvol=" + var3 + ", loadedt=" + this.loadedt);
      ...
      this.mutes = false;
      this.fase = 6;
      System.out.println("[LOADMUSIC] end stage=" + var1 + ", fase=" + this.fase + ", loadedt=" + this.loadedt + ", strack=" + (this.strack != null));
   }

   public void loadstrack(int var1, String var2, int var3) {
      System.out.println("[LOADSTRACK] stage=" + var1 + ", trackname=" + var2 + ", trackvol=" + var3);
      if (var1 == 1) {
            ...
            if (this.warning != 0 && this.warning != 210) {
               ...
               for (int var10 = var21; var10 >= 0; var10--) {
                  ...
                  if (var12) {
                     ...
                     while (var14 < this.lcmsg[var10].length()) {
               ...
               for (int var33 = 0; var33 < this.nplayers; var33++) {
                  if (var2.pos[var33] == var28 && var2.dested[var33] == 0 && !var31) {
                     ...
                     if (this.clangame != 0) {
                        ...
                        var58 = (int)(var58 + var58 * (this.m.snap[2] / 100.0F));
                        if (var58 > 255) {
                           var58 = 255;
                        }
    ...
    public void carselect(Control control, ContO[] contOArray, Mad mad, int n, int n2, boolean bl) {
        ...
        if ((this.multion != 0 || this.testdrive == 1 || this.testdrive == 2) && this.lsc != this.sc[0]) {
            ...
            for (n4 = 0; n4 < contOArray[this.sc[0]].npl && !bl2; ++n4) {
                ...
                this.arnp[2] = 1.0f - ((float[])object)[2];
                bl2 = true;
            }
            bl2 = false;
            for (n4 = 0; n4 < contOArray[this.sc[0]].npl && !bl2; ++n4) {
                ...
                this.arnp[5] = 1.0f - ((float[])object)[2];
                bl2 = true;
            }
