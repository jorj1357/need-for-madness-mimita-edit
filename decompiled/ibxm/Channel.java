    ...
    private void trigger() {
        ...
        if (this.noteKey > 0) {
            if (this.noteKey > 96) {
                ...
                if ((this.noteEffect == 117 || this.noteEffect == 242) && (fineTune = (this.noteParam & 0xF) << 4) > 127) {
                    fineTune -= 256;
                }
                ...
                int per = Channel.keyToPeriod(key, fineTune, this.module.linearPeriods);
